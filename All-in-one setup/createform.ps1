...
<# Begin: DataSource "Nedap-ons-csv-nedap-team-rules-delete" #>
$tmpPsScript = @'
...
Nedap-ons-csv-nedap-team-rules-delete
'@ 
Invoke-HelloIDDatasource -DatasourceName $dataSourceGuid_0_Name -DatasourceType "4" -DatasourceInput $tmpInput -DatasourcePsScript $tmpPsScript -DatasourceModel $tmpModel -returnObject ([Ref]$dataSourceGuid_0) 
<# End: DataSource "Nedap-ons-csv-nedap-team-rules-delete" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "Nedap - CSV - Delete Teams Rule" #>
$tmpSchema = @"
[{"key":"teamRules","templateOptions":{"label":"Team rules","required":true,"grid":{"columns":[{"headerName":"AFASOE id","field":"AFASOEid"},{"headerName":"AFASOE","field":"AFASOE"},{"headerName":"Function Id","field":"FunctionId"},{"headerName":"Functions","field":"Functions"},{"headerName":"Nedap Team Ids","field":"NedapTeamIds"},{"headerName":"Nedap Teams","field":"NedapTeams"}],"height":600,"rowSelection":"single"},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_0","input":{"propertyInputs":[]}},"useFilter":true,"useDefault":false},"type":"grid","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":true}]
"@ 

$dynamicFormGuid = [PSCustomObject]@{} 
$dynamicFormName = @'
Nedap - CSV - Delete Teams Rule
'@ 
...
'@; 
	...
	$tmpVariables = @'
[{"name":"afasOrgUnits","value":"{{form.teamRules.AFASOEid}}","secret":false,"typeConstraint":"string"},{"name":"functionIds","value":"{{form.teamRules.FunctionId}}","secret":false,"typeConstraint":"string"},{"name":"nedapTeamIds","value":"{{form.teamRules.NedapTeamIds}}","secret":false,"typeConstraint":"string"}]
'@ 

	$delegatedFormTaskGuid = [PSCustomObject]@{} 
$delegatedFormTaskName = @'
Nedap-ons-delete-team-rule
'@
