...
### Powershell data source '[powershell-datasource]_Nedap-ons-csv-nedap-team-rules-delete'
This Powershell data source retrieves the rules from the configured mapping file and shows which AFAS organisational units are mapped, optionally combined with AFAS jobtitles, with Nedap ONS teams.
...
## Getting help
If you need help, feel free to ask questions on our [forum](https://forum.helloid.com/forum/helloid-connectors/service-automation/565-helloid-sa-nedap-delete-employeerange-mapping)
